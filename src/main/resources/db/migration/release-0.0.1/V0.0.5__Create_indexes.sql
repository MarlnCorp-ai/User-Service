...
CREATE INDEX IF NOT EXISTS idx_user_type_active ON users(user_type, is_active);
CREATE INDEX IF NOT EXISTS  idx_created_at ON users(user_created_at);
CREATE INDEX IF NOT EXISTS  idx_user_first_name ON users(user_first_name);

-- Students table indexes (matching your entity @Index annotations)
CREATE INDEX IF NOT EXISTS idx_student_roll_no ON students(student_roll_no);
CREATE INDEX IF NOT EXISTS idx_student_id ON students(student_id);
CREATE INDEX IF NOT EXISTS idx_program_year ON students(program, year_of_study);
CREATE INDEX IF NOT EXISTS idx_course_id ON students(course_id);
CREATE INDEX IF NOT EXISTS idx_enrollment_date ON students(enrollment_date);
...
CREATE INDEX IF NOT EXISTS  idx_reporting_manager ON employees(reporting_manager_id);
...
CREATE INDEX IF NOT EXISTS  idx_users_active_type_email ON users(is_active, user_type, user_email) WHERE is_deleted = FALSE;
CREATE INDEX IF NOT EXISTS  idx_students_active_program ON students(student_status, program) WHERE student_status = 'ACTIVE';
CREATE INDEX IF NOT EXISTS  idx_employees_active_dept ON employees(employee_status, job_city) WHERE employee_status = 'ACTIVE';
